    ...
    <script>
        KindEditor.ready(function (K) {
            var editor1 = K.create('textarea[name="content1"]', {
                cssPath: '/cmfz/back/kindeditor/plugins/code/prettify.css',
                uploadJson: '/cmfz/back/kindeditor/jsp/upload_json.jsp',
                fileManagerJson: '/cmfz/back/kindeditor/jsp/file_manager_json.jsp',
