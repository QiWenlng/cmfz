...
<script>
    ...
    function removeChapter(chapterId) {
        $.messager.confirm('提示', '确定要删除此章节吗？', function (result) {
            if (result) {
...
<div id="chapterTable">
    ...
    <%--搜索框--%>
    <input id="chapterSearch" class="easyui-searchbox"
           data-options="
               searcher:query,
               prompt:'请输入查询条件....',
               menu:'#chaptermm',
